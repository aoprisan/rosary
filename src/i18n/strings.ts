...
const en: Dict = {
  ...
  spinHint: 'Trace one full circle around the rope to tell each bead.',
  ...
  ropeAria: 'Prayer rope — trace a full circle to tell one bead, or use arrow keys',
  beadAria: 'Bead',
...
const ro: Dict = {
  ...
  spinHint: 'Trasează un cerc complet pe șirag pentru a număra fiecare mărgea.',
  ...
  ropeAria: 'Șirag de rugăciune — trasează un cerc complet pentru a număra o mărgea sau folosește tastele săgeți',
  beadAria: 'Mărgea',
